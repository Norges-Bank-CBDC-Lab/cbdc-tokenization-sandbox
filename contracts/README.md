...
- [../docs/ARCHITECTURE.md](../docs/ARCHITECTURE.md) for how the contracts fit
  into the sandbox
- [./docs/contracts-security.md](./docs/contracts-security.md) for the
  current trust model, role model, and security assumptions
- [./docs/contracts-reference.md](./docs/contracts-reference.md) for a
...
- [../docs/KNOWN_ISSUES.md](../docs/KNOWN_ISSUES.md) for sandbox limitations
  that can affect local deployment or contract interaction
