...
/**
 * Since Allowlist is abstract, we create a simple inheritor to perform tests.
 */
contract BasicAllowlist is Allowlist {
    constructor(address owner) Allowlist(owner) {}
}
...
contract AllowlistTest is Test {
    ...
    function setUp() public {
        allowlist = new BasicAllowlist(admin);
     ...
     */
    function test_queryAll() public view {
