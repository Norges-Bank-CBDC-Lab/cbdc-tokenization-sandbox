...
- [Coupon and maturity](processes/coupon-redemption-sequence.md):
  WNOK coupon payments from the government reserve account, and the closing
  payment that repays principal and burns every unit.
