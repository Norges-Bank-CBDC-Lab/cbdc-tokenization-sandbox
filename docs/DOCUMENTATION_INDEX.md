...
- `docs/plans/browserslist-dev-transitive-refresh-plan.md`: Lockfile-only refresh of the development-scoped transitive `browserslist` (4.28.2 → 4.28.8, Dependabot alert #76) together with the five sibling packages it requires; no manifest or override change, gated by the structural lockfile diff and override audit.
