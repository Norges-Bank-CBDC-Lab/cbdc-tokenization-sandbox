...
| [0004](0004-settle-all-bond-cash-legs-in-wnok.md) | Settle every bond cash leg in wNOK from a government reserve account | Accepted |
| [0005](0005-redeem-principal-with-the-final-coupon.md) | Redeem principal with the final coupon and close the bond in one transaction | Accepted |
