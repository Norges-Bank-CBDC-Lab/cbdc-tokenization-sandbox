...
If the Swagger file or generator changes, regenerate the server and re-check the provenance notes in `THIRD_PARTY.md` before committing the updated output.
