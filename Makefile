...
BID_ENCRYPT_INPUT ?= scripts/bid-encryption/examples/auctions/seal.$(BID_TYPE).json
BID_ENCRYPT_BASIC_INPUT ?= scripts/bid-encryption/examples/basic/seal.$(BID_BASIC_TYPE).json
BID_ENCRYPT_OUTPUT ?= scripts/bid-submitter/examples/$(BID_TYPE).json
BID_ENCRYPT_BASIC_OUTPUT ?= scripts/bid-encryption/examples/basic/sealed.json
...
help:
	...
	@echo "  BID_ENCRYPT_INPUT  Plaintext bid input file"
	@echo "  BID_ENCRYPT_OUTPUT Sealed bids output file (also used by bid-submit)"
	@echo "  BID_KEYS           Bidder private keys map for bid-submit"
...
bid-encrypt-basic: require-basic-bid-vars
	@set -eu; \
...
bid-submit-basic: require-basic-bid-vars
	@set -eu; \
